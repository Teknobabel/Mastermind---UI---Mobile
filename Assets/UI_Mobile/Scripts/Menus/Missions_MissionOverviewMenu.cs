...
public class Missions_MissionOverviewMenu : MonoBehaviour, IMenu {
...
//			}
		...
		else if (m_missionPlan.m_currentMission == null || (m_missionPlan.m_currentMission != null
...
//			}
//		} else 
		if (m_missionPlan.m_state == MissionPlan.State.Active) {
